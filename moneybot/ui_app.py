    ...
    def realizar_compra(self, symbol):
        try:
            ...
            if not self.error_1003 and not self.saldo_insuficiente:
                ...
                if not self.strategy.resistencias_mercado(symbol, nearest_sell_price, order_book):
        ...
        while True:
            while not self.error_1003:
                ...
                if self.ordenes:
                    ...
                    self.symbols_list = self.strategy.seleccionar_simbolos(
                        tickers,
                        analizar_grafico_4h=self.analizar_grafico_4H,
                        analizar_grafico_5m=self.analizar_grafico_5m,
                    )
